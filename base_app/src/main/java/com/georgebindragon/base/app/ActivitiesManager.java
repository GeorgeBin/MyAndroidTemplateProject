...
public class ActivitiesManager implements Application.ActivityLifecycleCallbacks
{
   ...
   private ActivitiesManager.AppForegroundChangeCallBack callBack;
   ...
   public void setOnAppForegroundChangeCallBack(ActivitiesManager.AppForegroundChangeCallBack appForegroundChangeCallBack)
   {
